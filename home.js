...
const canWeDeliver = (zipcode) => {
  ...
  console.log("Sorry, we cant't deliver to that adddress.");
};

canWeDeliver(85213);
canWeDeliver(8521300);
...
let title = deals.title.replace("15% Off!", "10% Off!");
console.log(deals);
...
const desc = deals.desc.replace("March", "April").trim();
